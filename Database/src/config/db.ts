...
import {
  Evento, EventoDiaSemana, ProductoPromocion, Promocion, PromocionEventoDia
} from "../models"

//Importar credenciales
const DB_HOST = process.env.DB_HOST || "event-mysql"; 
...
export async function initializeDB() {
  ...
  const sequelize = new Sequelize({
    ...
    database: DB_NAME,
    models: [
      Evento, EventoDiaSemana, ProductoPromocion, Promocion,
      PromocionEventoDia
    ],
